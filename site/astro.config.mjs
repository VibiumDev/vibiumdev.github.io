    ...
    integrations: [
        starlight({
            ...
            sidebar: [
                ...
                { label: 'Run and Check', slug: 'docs/run-and-check' },
                { label: 'Model Providers', slug: 'docs/ai-providers' },
                { label: 'Using Firefox', slug: 'docs/using-firefox' },
                { label: 'Concurrent Sessions', slug: 'docs/sessions' },
